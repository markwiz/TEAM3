"""
Flappy Plane - lihtne 2D mäng, kus lennuk navigeerib läbi hoonete.
"""
import pygame
import sys
...
def draw_score(surface, score, high_score):
    """
    Näitab praegust skoori ja teie parimat skoori mängus.
...
def show_game_over(surface, score, high_score):
    """
    Kuvab mängu lõppekraani koos lõppskoori ja taaskäivitusjuhistega.
...
def main():
    """
    Põhiline mängutsükkel ja initsialiseerimine.
    Tegeleb mängu oleku, sündmuste töötlemise ja renderdamisega.
    """
    plane = Plane()
    skyscrapers = []
